      ...
      <main className="flex-1 flex flex-col h-full bg-[#090d16] overflow-hidden">
        ...
        <header className="h-16 px-8 border-b border-white/5 flex items-center justify-between bg-[#0f131c]/60 backdrop-blur-md shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-base text-white">Contatos & Carteiras</h1>
        ...
        {/* Filters & Actions Bar */}
        <div className="p-6 border-b border-white/5 bg-[#0a0e17]/50 flex flex-col sm:flex-row items-center justify-between gap-4 shrink-0">
          {/* Search */}
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="w-full bg-[#0f131c] border border-white/5 rounded-2xl overflow-hidden shadow-xl">
            <table className="w-full text-left border-collapse text-xs">
              <thead>
                <tr className="border-b border-white/5 bg-[#0a0e17] text-slate-400 text-[11px] uppercase tracking-wider font-semibold">
                  ...
                  contacts.map((contact) => (
                    <tr key={contact.id} className="hover:bg-white/[0.02] transition-colors">
                      ...
                      <td className="py-4 px-6">
                        <div className="flex items-center gap-3">
                          <div className="w-9 h-9 rounded-full bg-indigo-600/20 border border-indigo-500/30 flex items-center justify-center font-bold text-xs text-indigo-300">
                      ...
                      {/* Wallet Assignee */}
                      <td className="py-4 px-6">
                        <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-white/5 text-xs text-slate-300">
